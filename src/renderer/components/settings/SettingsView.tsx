...
import { Settings, Terminal, CheckSquare, Bot, Palette, Save, RotateCcw, Loader2, CheckCircle, XCircle } from 'lucide-react';
import { useSettingsStore } from '../../stores/settings-store';
import type { AppSettings } from '../../../shared/types';
import { cn } from '../../../shared/utils';

type SettingsSection = 'terminal' | 'clickup' | 'agent' | 'appearance';
